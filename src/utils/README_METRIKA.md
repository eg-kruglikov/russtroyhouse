...
### Пример 5: Медиа и галереи

```javascript
// Ничего дополнительно делать не нужно:
// FullWidthViewportVideo сам отправит:
// - ymGoal("video_sound_on") и ymNotBounce(), когда пользователь включит звук

// FullWidthImageGallery (и PhotoGrid) отправит:
// - ymGoal("gallery_swipe") и ymNotBounce(), когда пользователь пролистает галерею
```
